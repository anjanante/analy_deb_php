...
<div class="wrap">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2 data-aos="fade-down">Welcome to <span><?php echo siteName(); ?></span></h2>
                            <p data-aos="fade-up">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
    ...
    <!--    <footer><small>&copy;--><?php //echo date('Y'); ?><!-- -->
    <?php //siteName(); ?><!--. All rights reserved.</small></footer>-->
</div>
